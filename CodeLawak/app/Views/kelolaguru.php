            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- validation -->
                        <!-- ini form action menggunakan fungsi insert_guru yang berada pada control_guru -->

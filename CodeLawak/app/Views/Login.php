...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="card card0 border-0">
            ...
            <div class="bg-success py-4" id="gradient">
                <div class="row px-3"> <small class="ml-4 ml-sm-5 mb-2" style="color: #EEEEEE;">Copyright &copy; 2021. All rights reserved.</small>

            ...
            <div class="col-sm-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- validation -->
                        <form action="<?php echo base_url('control_soal/insert_soal'); ?>" method="post">
